...
function ExecutionsTable({ initialData, workflowId }: Props) {
                                ...
                                <TableCell>
                                    <div className='flex flex-col'>
                                        <div className='flex gap-2 items-center'>
                                            ...
                                            <span className='font-sans capitalize'>{execution.status}</span>
                                        </div>
                                ...
                                <TableCell>
                                    <div className='flex flex-col'>
                                        <div className='flex gap-2 items-center'>
                                            ...
                                            <span className='font-sans capitalize'>{execution.creditsConsumed}</span>
                                        </div>
